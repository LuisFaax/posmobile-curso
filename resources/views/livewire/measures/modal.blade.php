    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-header">
                <h2 class="font-medium text-base mr-auto">Gestión de Medidas</h2>
            </div>
            ...
            <div class="modal-body">
                <div x-data="{}" @open-modal.window="setTimeout(() => { $refs.first.focus() }, 900)">
                    ...
                    <input type="text" wire:model.defer="name" x-ref="first" wire:keydown.enter="Store" wire:loading.attr="disabled" class="form-control" placeholder="ej: Pieza">
